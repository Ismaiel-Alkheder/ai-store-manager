...
async function getAccessToken() {
    ...
    if (
        ...
        throw new Error(
            "Shopify access token missing from response"
        );
    }
...
async function updateService(
    ...
    if (!service) {
        throw new Error(
            "Shopify did not return the updated fulfillment service"
        );
    }
            ...
            return NextResponse.json(
                {
                    ...
                    error:
                        `${SERVICE_NAME} was not found. This route will not create a new fulfillment service.`,
                },
                {
                    status:
                        404,
